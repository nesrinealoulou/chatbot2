...
def save_index(index, metadata, index_path="embeddings/index.faiss", meta_path="embeddings/metadata.json"):
    faiss.write_index(index, index_path)
    with open(meta_path, "w") as f:
        json.dump(metadata, f)

def load_index(index_path="embeddings/index.faiss", meta_path="embeddings/metadata.json"):
